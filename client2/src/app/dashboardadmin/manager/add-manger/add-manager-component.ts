...
export class AddManagerComponent implements OnInit {
  ...
  errorMessage = '';
  constructor(protected service: NbAuthService, private serviceClient: ManagerService,
...
this.service.getToken();
    ...
    addClient(){
      ...
      this.serviceClient.CreateManager(firstname , lastName , email, password, address, this.phone, this.date, postalCode, city);
